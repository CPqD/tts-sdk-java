...
public class SynthesisSession
{
	 ...
	 */
	private static final int TTS_PARAM_TEXT_BREAKLINE = 0x0E;
	 ...
	 * This parameter should be an @b interger value '1' (is true) or '0' (is false). The default value is 0.
	 */
	private static final int TTS_PARAM_LOG_TEXT = 0x0F;
	 ...
	 * This parameter expects an @b string value.
	 */
	private static final int TTS_PARAM_LICENSE_ID = 0x10;
	 ...
	 * This parameter expects an @b string value.
	 */
	private static final int TTS_PARAM_LICENSE_TAG = 0x11;
	 ...
	 * This parameter expects an @b string value.
	 */
	private static final int TTS_PARAM_LICENSE_ACCOUNT = 0x12;
	...
	public boolean getTextBreakLine() throws SynthesisException
	{
		validate();

		return engine.wrapper.getBooleanParameter(handle, TTS_PARAM_TEXT_BREAKLINE);
	}

	public boolean getLogText() throws SynthesisException
	{
		validate();

		return engine.wrapper.getBooleanParameter(handle, TTS_PARAM_LOG_TEXT);
	}

	public String getLicenseID() throws SynthesisException
	{
		validate();

		return engine.wrapper.getStringParameter(handle, TTS_PARAM_LICENSE_ID);
	}

	public String getLicenseTag() throws SynthesisException
	{
		validate();

		return engine.wrapper.getStringParameter(handle, TTS_PARAM_LICENSE_TAG);
	}

	public String getLicenseAccount() throws SynthesisException
	{
		validate();

		return engine.wrapper.getStringParameter(handle, TTS_PARAM_LICENSE_ACCOUNT);
	}
	...
	public void setTextBreakLine( boolean value ) throws SynthesisException
	{
		validate();

		engine.wrapper.setBooleanParameter(handle, TTS_PARAM_TEXT_BREAKLINE, value);
	}

	public void setLogText( boolean value ) throws SynthesisException
	{
		validate();

		engine.wrapper.setBooleanParameter(handle, TTS_PARAM_LICENSE_TAG, value);
	}

	public void setLicenseAccount( String value ) throws SynthesisException
	{
		validate();

		engine.wrapper.setStringParameter(handle, TTS_PARAM_LICENSE_ACCOUNT, value);
	}
