...
Para executar um exemplo, utilize um comando similar ao abaixo, escolhendo o JAR correspondente ao programa que deseja executar.
	...
	# java -jar target/synthesizer-examples-4.5-V1-simple.jar <productPath> <text or file name> 
...
**Importante**: os programas de exemplo esperam que o arquivo ``synthesizer-4.5-V1.jar`` esteja dentro do diretório ``lib`` a partir de onde o JAR do exemplo encontra-se.
